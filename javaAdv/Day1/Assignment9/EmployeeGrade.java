...
public class EmployeeGrade{
	...
	public void initializeEmpoyee(int employeeNo, String employeeName, float customer1Feedback, float customer2Feedback){
		this.employeeNo = employeeNo;
		this.employeeName = employeeName;
		this.customer1Feedback = customer1Feedback;
		this.customer2Feedback = customer2Feedback;
	...
	public void calculateAverageFeedback(){
		if(this.customer3Feedback==0) this.averageFeedback = (this.customer1Feedback+this.customer2Feedback)/2;
		else this.averageFeedback = (this.customer1Feedback+this.customer2Feedback+this.customer3Feedback)/3;
